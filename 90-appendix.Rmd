...
- You'll have to register and either get the Chrome extension or save the bookmarklet. It's simple. **Please pick a username that makes it easy for me to figure out who you are for grading purposes.** "John_Doe" or "J-Doe" is good, "jr435d" is not. 
...
- Finally come back to this to this site and post an annotation anywhere on the site AND **to the philosophy group** you just joined.


#### 5. More Details


**_Step one, login:_** Click the arrow on the top right of the screen to open up the Hypothes.is tool, then click where it says "Login." Enter your ID (most likely your email address) and password. If you haven't registered yet go to the [start Here page](https://web.hypothes.is/start/), follow the instructions then come back to this step.
